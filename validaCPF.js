function geral() {
    ...
    const form2 = document.getElementById('val2');
    ...
    form2.addEventListener('submit', function (e) {
        ...
        //Código para gerar e validar CPF:
        //Essa função faz a geração de um cpf com base no algorítmo de multiplicação
        //dos dígitos:
        //Código para gerar e validar CPF:
        //Essa função faz a geração de um cpf com base no algorítmo de multiplicação
        //dos dígitos:
        function gerarCPF() {
            ...
            const cpf = `CPF gerado: ${d1}${d2}${d3}.${d4}${d5}${d6}.${d7}${d8}${d9}-${d10}${d11}`;
            document.querySelector('#gerado').innerText = cpf;
            console.log(cpf);
